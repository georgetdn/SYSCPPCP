...
## Requirements:
Windows 10, 11 and Visual Studio Community 2022 (64-bit) - Current Version 17.11.5  (VS Code is not supported).  [Linux version](https://github.com/georgetdn/SYSCPPCPlinux).
## Installing  
